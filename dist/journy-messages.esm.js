...
const SettingsPanel = ({ isOpen, onClose, settings, onSettingsChange, configInfo, }) => {
    ...
    return (React.createElement("div", { className: `journy-settings-panel ${isOpen ? 'journy-settings-panel-open' : 'journy-settings-panel-closed'}`, onClick: (e) => e.stopPropagation() },
        React.createElement("div", { className: "journy-settings-header" },
            ...
            React.createElement("button", { type: "button", className: "journy-settings-close", onClick: handleCancel, title: "Close settings", "aria-label": "Close settings" }, "\u00D7")),
        React.createElement("div", { className: "journy-settings-body" },
            ...
            React.createElement("div", { className: "journy-settings-item" },
                ...
                React.createElement("button", { type: "button", className: `journy-settings-toggle ${draft.showReadMessages ? 'journy-settings-toggle-on' : ''}`, onClick: () => handleToggle('showReadMessages'), role: "switch", "aria-checked": draft.showReadMessages },
            ...
            React.createElement("div", { className: "journy-settings-item" },
                ...
                React.createElement("button", { type: "button", className: `journy-settings-toggle ${draft.autoExpandOnNew ? 'journy-settings-toggle-on' : ''}`, onClick: () => handleToggle('autoExpandOnNew'), role: "switch", "aria-checked": draft.autoExpandOnNew },
                    React.createElement("span", { className: "journy-settings-toggle-knob" }))),
            React.createElement("div", { className: "journy-settings-item" },
            ...
            showAdvanced && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "journy-settings-item journy-settings-item-vertical" },
                    ...
                    React.createElement("input", { type: "text", className: "journy-settings-input", value: draft.apiEndpoint, onChange: (e) => update({ apiEndpoint: e.target.value }), placeholder: DEFAULT_API_ENDPOINT })),
        ...
        React.createElement("div", { className: "journy-settings-footer" },
            React.createElement("button", { type: "button", className: "journy-settings-btn journy-settings-btn-secondary", onClick: handleCancel }, "Cancel"),
            React.createElement("button", { type: "button", className: "journy-settings-btn journy-settings-btn-primary", onClick: handleSave, disabled: !isDirty }, "Save"))));
};
...
const DragHandle = ({ onMouseDown, title = 'Drag to move', className = 'journy-message-widget-drag-handle', }) => (React.createElement("div", { className: className, onMouseDown: onMouseDown, title: title },
    React.createElement("svg", { viewBox: "0 0 684 684", xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20" },
        React.createElement("g", { fill: "none" },
            React.createElement("circle", { cx: "342", cy: "342", fill: "#fff", r: "342" }),
            React.createElement("circle", { cx: "343.5", cy: "343.5", fill: "#f2994a", r: "156.5" }),
            React.createElement("path", { d: "m344 68c151.878306 0 275 123.121694 275 275s-123.121694 275-275 275-275-123.121694-275-275 123.121694-275 275-275zm.5 46c-126.74935 0-229.5 102.75065-229.5 229.5s102.75065 229.5 229.5 229.5 229.5-102.75065 229.5-229.5-102.75065-229.5-229.5-229.5z", fill: "#528afa" })))));
...
const WidgetHeader = ({ isCollapsed, isListMode, unreadCount, displayMessage, allMessagesToShow, onToggleExpand, onClose, onCloseWidget, onOpenSettings, handleMouseDown, }) => {
    if (isCollapsed) {
        return (React.createElement("div", { className: "journy-message-widget-header journy-message-widget-header--pill", onMouseDown: handleMouseDown },
            React.createElement("div", { className: "journy-message-widget-logo-wrapper" },
                React.createElement(DragHandle, null),
                unreadCount > 0 && (React.createElement("span", { className: "journy-message-widget-logo-badge" }, unreadCount))),
            React.createElement("span", { className: "journy-message-widget-pill-title" }, "Messages"),
            React.createElement("div", { className: "journy-message-widget-avatar-slot" },
                React.createElement("button", { type: "button", className: "journy-message-widget-close journy-message-widget-close--pill", onClick: (e) => {
                        e.stopPropagation();
                        e.preventDefault();
                        onCloseWidget ? onCloseWidget() : onClose();
                    }, onMouseDown: (e) => e.stopPropagation(), title: "Close widget", "aria-label": "Close" }, "\u00D7"))));
    }
    return (React.createElement("div", { className: "journy-message-widget-header", onMouseDown: handleMouseDown },
        React.createElement(DragHandle, null),
        React.createElement("div", { className: "journy-message-widget-header-content" },
            unreadCount > 0 && (React.createElement("span", { className: "journy-message-widget-badge" }, unreadCount)),
            React.createElement("span", { className: "journy-message-widget-title" }, displayMessage
        ...
        React.createElement("div", { className: "journy-message-widget-controls" },
            isDebugSettings() && (React.createElement("button", { type: "button", className: "journy-message-widget-settings-btn", onClick: (e) => {
                    e.stopPropagation();
                    e.preventDefault();
                    onOpenSettings();
            ...
            React.createElement("button", { type: "button", className: "journy-message-widget-toggle", onClick: (e) => {
                    e.stopPropagation();
                    e.preventDefault();
                    onToggleExpand();
                }, onMouseDown: (e) => {
            ...
            React.createElement("button", { type: "button", className: "journy-message-widget-close", onClick: (e) => {
                    e.stopPropagation();
                    e.preventDefault();
                    onCloseWidget ? onCloseWidget() : onClose();
                }, onMouseDown: (e) => {
...
const MessageRenderer = ({ message, onClick }) => (React.createElement(React.Fragment, null,
    React.createElement("div", { className: "journy-message-content journy-message-content-clickable", dangerouslySetInnerHTML: { __html: sanitizeHtml(message.message) }, onClick: onClick }),
    message.createdAt && (React.createElement("div", { className: "journy-message-timestamp" }, formatTimestamp(message.createdAt)))));
...
const WidgetListView = ({ messages, contentRef, isEmpty, onMessageReceived, onDismissMessage, onContentClick, handleResizeStart, }) => (React.createElement(React.Fragment, null,
    isEmpty ? (React.createElement("div", { className: "journy-message-widget-content journy-message-widget-empty" },
        React.createElement("p", null, "No unread messages"))) : (React.createElement("div", { ref: contentRef, className: "journy-message-widget-content" }, messages.map((message, index) => (React.createElement(MessageRow, { key: message.id, message: message, isSeparated: index < messages.length - 1, onMessageReceived: onMessageReceived, onDismissMessage: onDismissMessage, scrollRoot: contentRef },
        React.createElement(MessageRenderer, { message: message, onClick: (e) => onContentClick(message, e) })))))),
    React.createElement(ResizeHandle, { onMouseDown: handleResizeStart })));

/** Renders the expanded single/widget-mode content: one message at a time with prev/next navigation. */
const WidgetSingleView = ({ displayMessage, allMessagesToShow, currentMessageIndex, canGoPrev, canGoNext, onMessageReceived, onDismissMessage, onContentClick, onPrevMessage, onNextMessage, }) => (React.createElement(React.Fragment, null,
    React.createElement("div", { className: "journy-message-widget-content journy-message-widget-content--single" }, displayMessage ? (React.createElement(MessageRow, { message: displayMessage, isSeparated: false, onMessageReceived: onMessageReceived, onDismissMessage: onDismissMessage },
        React.createElement(MessageRenderer, { message: displayMessage, onClick: (e) => onContentClick(displayMessage, e) }))) : null),
    allMessagesToShow.length > 1 && (React.createElement("div", { className: "journy-message-widget-position" },
        React.createElement("button", { type: "button", className: "journy-message-widget-nav", onClick: (e) => {
                e.stopPropagation();
                e.preventDefault();
                onPrevMessage?.();
            }, title: "Previous message", "aria-label": "Previous", disabled: !canGoPrev }, "\u2039"),
        React.createElement("span", { className: "journy-message-widget-position-text" },
...
const MessageWidget = ({ store, onClose, onCloseWidget, onLinkClick, onToggleExpand, onMessageReceived, onDismissMessage, onNextMessage, onPrevMessage, onSettingsChange, configInfo, initialSettings, }) => {
    ...
    return (React.createElement("div", { ref: widgetRef, className: `journy-message-widget ${!isCollapsed ? 'journy-message-widget-expanded' : 'journy-message-widget-collapsed'} ${isDragging ? 'journy-message-widget-dragging' : ''} ${isResizing ? 'journy-message-widget-resizing' : ''}`, style: {
        ...
        React.createElement(WidgetHeader, { isCollapsed: isCollapsed, isListMode: isListMode, unreadCount: unreadCount, displayMessage: displayMessage, allMessagesToShow: allMessagesToShow, onToggleExpand: onToggleExpand, onClose: onClose, onCloseWidget: onCloseWidget, onOpenSettings: () => setIsSettingsOpen(true), handleMouseDown: handleMouseDown }),
        !isCollapsed && isListMode && (React.createElement(WidgetListView, { messages: allMessagesToShow, contentRef: contentRef, isEmpty: allMessagesToShow.length === 0, onMessageReceived: onMessageReceived, onDismissMessage: onDismissMessage, onContentClick: handleContentClick, handleResizeStart: handleResizeStart })),
        !isCollapsed && !isListMode && allMessagesToShow.length > 0 && (React.createElement(WidgetSingleView, { displayMessage: displayMessage, allMessagesToShow: allMessagesToShow, currentMessageIndex: currentMessageIndex, canGoPrev: canGoPrev, canGoNext: canGoNext, onMessageReceived: onMessageReceived, onDismissMessage: onDismissMessage, onContentClick: handleContentClick, onPrevMessage: onPrevMessage, onNextMessage: onNextMessage })),
