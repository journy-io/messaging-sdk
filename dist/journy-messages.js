(function (global, factory) {
    ...
    const SettingsPanel = ({ isOpen, onClose, settings, onSettingsChange, configInfo, }) => {
        ...
        return (React__namespace.createElement("div", { className: `journy-settings-panel ${isOpen ? 'journy-settings-panel-open' : 'journy-settings-panel-closed'}`, onClick: (e) => e.stopPropagation() },
            ...
            React__namespace.createElement("div", { className: "journy-settings-body" },
                ...
                draft.displayMode === 'banner' && (React__namespace.createElement(React__namespace.Fragment, null,
                    React__namespace.createElement("div", { className: "journy-settings-item" },
    ...
    const BannerView = ({ message, position, autoDismissMs, onDismissMessage, onMessageReceived, onContentClick, }) => {
        ...
        return (React__namespace.createElement("div", { className: `journy-message-banner journy-message-banner-${position} ${isExiting ? 'journy-message-banner-exiting' : ''} ${isResizing ? 'journy-message-banner-resizing' : ''}`, role: "status", "aria-live": "polite", style: { width: `${size.width}px`, minHeight: `${size.height}px` }, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
            React__namespace.createElement("div", { className: "journy-message-banner-content" },
                React__namespace.createElement(MessageRenderer, { message: message, onClick: (e) => onContentClick(message, e) })),
            ...
            React__namespace.createElement("div", { className: `journy-message-banner-resize-handle ${resizeCornerClass}`, onMouseDown: handleResizeStart, title: "Resize banner", "aria-label": "Resize banner" })));
    };
    ...
    const MessageWidget = ({ store, onClose, onCloseWidget, onLinkClick, onToggleExpand, onMessageReceived, onDismissMessage, onNextMessage, onPrevMessage, onSettingsChange, configInfo, initialSettings, }) => {
        ...
        if (isBannerMode) {
            return (React__namespace.createElement(React__namespace.Fragment, null,
                currentMessage ? (React__namespace.createElement(BannerView, { message: currentMessage, position: settings.bannerPosition, autoDismissMs: settings.bannerAutoDismissMs, onMessageReceived: onMessageReceived, onDismissMessage: onDismissMessage, onContentClick: handleContentClick })) : null,
                modalMessage ? (React__namespace.createElement(MessagePopup, { message: modalMessage, onClose: () => setModalMessage(null), onLinkClick: onLinkClick })) : null,
                isDebugSettings() ? (React__namespace.createElement("div", { className: "journy-banner-settings-host" },
